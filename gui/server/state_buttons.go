...
//
// Default style classes: "gui-CheckBox", "gui-CheckBox-Disabled"
...
// Suggested event type to handle changes: ETypeClick
//
// Default style classes: "gui-SwitchButton", "gui-SwitchButton-On-Active"
// "gui-SwitchButton-On-Inactive", "gui-SwitchButton-Off-Active",
// "gui-SwitchButton-Off-Inactive"
...
// Suggested event type to handle changes: ETypeClick
//
// Default style classes: "gui-RadioButton", "gui-RadioButton-Disabled"
...
func NewCheckBox(text string) CheckBox {
	c := newStateButtonImpl(text, strCheckbox, nil, "gui-CheckBox-Disabled")
	c.Style().AddClass("gui-CheckBox")
	return c
}
...
func NewSwitchButton() SwitchButton {
	...
	c.Style().AddClass("gui-SwitchButton")
	c.SetState(false)
	return c
}
...
func NewRadioButton(text string, group RadioGroup) RadioButton {
	c := newStateButtonImpl(text, strRadio, group, "gui-RadioButton-Disabled")
	c.Style().AddClass("gui-RadioButton")
	return c
}
...
func (c *switchButtonImpl) SetState(state bool) {
	...
	if c.state {
		c.onButton.Style().SetClass("gui-SwitchButton-On-Active")
		c.offButton.Style().SetClass("gui-SwitchButton-Off-Inactive")
	} else {
		c.onButton.Style().SetClass("gui-SwitchButton-On-Inactive")
		c.offButton.Style().SetClass("gui-SwitchButton-Off-Active")
	}
}
